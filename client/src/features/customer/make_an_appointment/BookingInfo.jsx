        ...
        const fetchPatientProfile = async () => {
            try {
                ...
                const response = await axios.get(
                    'http://localhost:5000/api/patient', // Đảm bảo cổng chính xác
        ...
        <div className="main-content">
            <div className="form-card">
                <div className="form-header">
                    <img src={`http://localhost:5000/images/${patientData.avata || 'avatar.webp'}`} alt="Bệnh nhân" className="patient-avatar" />
                    <h2 className="title">
